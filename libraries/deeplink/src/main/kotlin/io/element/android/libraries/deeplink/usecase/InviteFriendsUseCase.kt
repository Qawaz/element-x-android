        ...
        permalinkResult.fold(
            onSuccess = { permalink ->
                ...
                startSharePlainTextIntent(
                    ...
                    chooserTitle = stringProvider.getString(StringR.string.action_invite_friends),
                    text = stringProvider.getString(StringR.string.invite_friends_text, appName, permalink),
                    extraTitle = stringProvider.getString(StringR.string.invite_friends_rich_title, appName),
